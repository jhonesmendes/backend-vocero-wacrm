...
const nextConfig: NextConfig = {
  // Produz um runtime Node.js mínimo para o container de produção.
  // Consulte a documentação de `output: 'standalone'` do Next.js antes
  // de remover esta opção: o Dockerfile copia também public e .next/static.
  output: "standalone",
  /**
